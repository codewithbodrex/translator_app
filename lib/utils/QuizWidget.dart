...
TextFormField quizEditTextStyle(String hintText,
    {bool isPassword = false, Function(String)? onChanged}) {
  return TextFormField(
    style: primaryTextStyle(),
    obscureText: isPassword,
    onChanged: onChanged, // Tambahkan onChanged di sini
...
TextFormField translateEditTextFalse(var hintText,
    {isPassword = true, readOnly = true}) {
  return TextFormField(
    style: primaryTextStyle(),
    obscureText: isPassword,
    readOnly: readOnly, // Membuat TextFormField tidak dapat diedit
    decoration: InputDecoration(
      contentPadding: EdgeInsets.fromLTRB(16, 22, 16, 22),
      hintText: hintText,
      border: InputBorder.none,
...
class _CustomDropdownState extends State<CustomDropdown> {
  ...
  Widget build(BuildContext context) {
    return Align(
      alignment: Alignment.centerLeft, // Meletakkan dropdown di sebelah kiri
      child: Container(
        width: 200, // Lebar tetap dropdown sesuai kebutuhan Anda
